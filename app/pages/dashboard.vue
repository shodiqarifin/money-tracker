...
<template>
  <ClientOnly>
    <div class="max-w-3xl mx-auto p-4 space-y-6">
      ...
      <div v-if="loading" class="text-center py-12 text-muted">Memuat...</div>
      ...
      <template v-else-if="summary">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div class="bg-primary text-white rounded-2xl p-5">
            ...
            <p class="text-2xl font-bold leading-tight">{{ formatRupiah(summary.allTime.balance) }}</p>
          ...
          <div class="bg-surface border border-white/10 rounded-2xl p-5">
            ...
            <p class="text-2xl font-bold text-green-400 leading-tight">{{ formatRupiah(summary.thisMonth.income) }}</p>
          ...
          <div class="bg-surface border border-white/10 rounded-2xl p-5">
            ...
            <p class="text-2xl font-bold text-foreground leading-tight">{{ formatRupiah(summary.thisMonth.expense) }}</p>
            <p
        ...
        <div class="bg-surface border border-white/10 rounded-2xl p-5">
          ...
          <div v-else class="space-y-4">
            <div v-for="cat in topCategoriesWithPercent" :key="cat.id">
              ...
              <div class="h-1.5 bg-white/10 rounded-full overflow-hidden">
                <div class="h-full bg-primary rounded-full transition-all duration-500" :style="{ width: cat.percent + '%' }" />
              </div>
